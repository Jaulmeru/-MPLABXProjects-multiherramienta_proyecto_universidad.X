\chapter{UART}
\hypertarget{md_documentacion_2_u_a_r_t}{}\label{md_documentacion_2_u_a_r_t}\index{UART@{UART}}
\label{md_documentacion_2_u_a_r_t_autotoc_md0}%
\Hypertarget{md_documentacion_2_u_a_r_t_autotoc_md0}%
\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md1}{}\doxysection{\texorpdfstring{Que es y como funciona}{Que es y como funciona}}\label{md_documentacion_2_u_a_r_t_autotoc_md1}
\mbox{[}WIP\mbox{]} Explicacion y base teorica sobre UART\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md2}{}\doxysection{\texorpdfstring{Impliementación en PIC18\+F45\+K50}{Impliementación en PIC18\+F45\+K50}}\label{md_documentacion_2_u_a_r_t_autotoc_md2}
...
\DoxyHorRuler{0}
\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md4}{}\doxysubsection{\texorpdfstring{Configuracion de transmision Asincrona}{Configuracion de transmision Asincrona}}\label{md_documentacion_2_u_a_r_t_autotoc_md4}
...
\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md5}{}\doxysubsubsection{\texorpdfstring{1 -\/ Configurar los baudios}{1 -\/ Configurar los baudios}}\label{md_documentacion_2_u_a_r_t_autotoc_md5}
...
\end{longtabu}
\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md6}{}\doxysubsubsection{\texorpdfstring{2 -\/ Configurar pines como tri-\/estado}{2 -\/ Configurar pines como tri-\/estado}}\label{md_documentacion_2_u_a_r_t_autotoc_md6}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md7}{}\doxysubsubsection{\texorpdfstring{3 -\/ Habilitacion del puerto serie}{3 -\/ Habilitacion del puerto serie}}\label{md_documentacion_2_u_a_r_t_autotoc_md7}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md8}{}\doxysubsubsection{\texorpdfstring{4 -\/ 9bits}{4 -\/ 9bits}}\label{md_documentacion_2_u_a_r_t_autotoc_md8}
Estas funcion si bien podemos agregarla en un futuro. Por el momento no sera inplementada.\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md9}{}\doxysubsubsection{\texorpdfstring{5 -\/ Inversion de polaridad}{5 -\/ Inversion de polaridad}}\label{md_documentacion_2_u_a_r_t_autotoc_md9}
No implementada ~\newline
\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md10}{}\doxysubsubsection{\texorpdfstring{6 -\/ Habilitar transmision}{6 -\/ Habilitar transmision}}\label{md_documentacion_2_u_a_r_t_autotoc_md10}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md11}{}\doxysubsubsection{\texorpdfstring{7 -\/ Interrupcciones}{7 -\/ Interrupcciones}}\label{md_documentacion_2_u_a_r_t_autotoc_md11}
No implementado\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md12}{}\doxysubsubsection{\texorpdfstring{8 -\/ Carga bit 9}{8 -\/ Carga bit 9}}\label{md_documentacion_2_u_a_r_t_autotoc_md12}
No implementado\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md13}{}\doxysubsubsection{\texorpdfstring{9 -\/ Carga de dato}{9 -\/ Carga de dato}}\label{md_documentacion_2_u_a_r_t_autotoc_md13}
Aqui solante se trata de cargar el dato a TXREG1 que lo pasara paralelamente a TSR (Transmit Shift Register). El cual pasara los datos hacia el pin de forma serial. ~\newline
 Si bien no esta especificado en las instrucciones anteriores se agregara una pequeña funcion con el registro TRMT. Este estara en 0 mientras aun haya datos pendientes en TSR.\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md14}{}\doxysubsection{\texorpdfstring{Configuración de Recepción Asincrónica}{Configuración de Recepción Asincrónica}}\label{md_documentacion_2_u_a_r_t_autotoc_md14}
...
\end{DoxyEnumerate}\end{quote}
Como se ve, hasta el paso 6 es lo mismo para la transmision, asi que lo obviaremos.\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md15}{}\doxysubsubsection{\texorpdfstring{7 -\/ Habilitar recepcion}{7 -\/ Habilitar recepcion}}\label{md_documentacion_2_u_a_r_t_autotoc_md15}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md16}{}\doxysubsubsection{\texorpdfstring{8 -\/ Revisar bandera}{8 -\/ Revisar bandera}}\label{md_documentacion_2_u_a_r_t_autotoc_md16}
...
Se va a leer el registro, cuando este tenga 1 significa que hay un dato esperando a ser leido.\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{9 -\/ Leer errores}{9 -\/ Leer errores}}\label{md_documentacion_2_u_a_r_t_autotoc_md17}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md18}{}\doxysubsubsection{\texorpdfstring{10 -\/ Leer dato}{10 -\/ Leer dato}}\label{md_documentacion_2_u_a_r_t_autotoc_md18}
Para obtener el dato siemplemente hay que leer el registro RCREG1\hypertarget{md_documentacion_2_u_a_r_t_autotoc_md19}{}\doxysubsubsection{\texorpdfstring{11 -\/ Borrar error de desbordamiento}{11 -\/ Borrar error de desbordamiento}}\label{md_documentacion_2_u_a_r_t_autotoc_md19}
