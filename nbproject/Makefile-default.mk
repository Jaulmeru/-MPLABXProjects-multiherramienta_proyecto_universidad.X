...
SOURCEFILES_QUOTED_IF_SPACED=src/main.c src/librerias/UART.c src/librerias/clock.c src/librerias/commandLine.c src/CLHandler.c src/librerias/SPI.c src/pinConfig.c src/librerias/ST7789.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/librerias/UART.p1 ${OBJECTDIR}/src/librerias/clock.p1 ${OBJECTDIR}/src/librerias/commandLine.p1 ${OBJECTDIR}/src/CLHandler.p1 ${OBJECTDIR}/src/librerias/SPI.p1 ${OBJECTDIR}/src/pinConfig.p1 ${OBJECTDIR}/src/librerias/ST7789.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/librerias/UART.p1.d ${OBJECTDIR}/src/librerias/clock.p1.d ${OBJECTDIR}/src/librerias/commandLine.p1.d ${OBJECTDIR}/src/CLHandler.p1.d ${OBJECTDIR}/src/librerias/SPI.p1.d ${OBJECTDIR}/src/pinConfig.p1.d ${OBJECTDIR}/src/librerias/ST7789.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/librerias/UART.p1 ${OBJECTDIR}/src/librerias/clock.p1 ${OBJECTDIR}/src/librerias/commandLine.p1 ${OBJECTDIR}/src/CLHandler.p1 ${OBJECTDIR}/src/librerias/SPI.p1 ${OBJECTDIR}/src/pinConfig.p1 ${OBJECTDIR}/src/librerias/ST7789.p1

# Source Files
SOURCEFILES=src/main.c src/librerias/UART.c src/librerias/clock.c src/librerias/commandLine.c src/CLHandler.c src/librerias/SPI.c src/pinConfig.c src/librerias/ST7789.c
...
${OBJECTDIR}/src/librerias/ST7789.p1: src/librerias/ST7789.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/src/librerias" 
	@${RM} ${OBJECTDIR}/src/librerias/ST7789.p1.d 
	@${RM} ${OBJECTDIR}/src/librerias/ST7789.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=pickit3   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/src/librerias/ST7789.p1 src/librerias/ST7789.c 
	@-${MV} ${OBJECTDIR}/src/librerias/ST7789.d ${OBJECTDIR}/src/librerias/ST7789.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/src/librerias/ST7789.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
